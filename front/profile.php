			...
			<div class="col-md-1">
				...
				<div class="col-md-7" style="width:95%; border-style:rounded;">
					<div class="panel panel-info">
						<div id="questions">
							<input type="button" class="button" value="View Created Questions" onclick="ViewCQ();" />
							<input type="button" class="button" value="View Created Tests" onclick="ViewCT();" />
		...
		hr.onreadystatechange = function(){
			if(hr.readyState == 4){
				...
				for(var i=0;i<len;i++){
					...
					lefthtml+='<td>'+Qrateup+'</td>';
					lefthtml+='<td>'+Qratedown+'</td>';
				...
				if(ajaxRequest.readyState == 4){
					...
					if(response=="yes"){
						...
						for(var i=1;i<len;i++){
							...
							html+="<input type='button' id='button"+examid+"' name='questionlist' id='"+examid+"' onclick='SelectExam("+sendobjt+")'";			
